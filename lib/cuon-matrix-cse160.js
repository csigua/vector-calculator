...
class Vector3 {
    ...
    static cross(other1, other2) {
        ...
        let v3 = new Vector3([
          other1.elements[1] * other2.elements[2] - other2.elements[1] * other1.elements[2],
          -(other1.elements[0] * other2.elements[2] - other2.elements[0] * other1.elements[2]),
          other1.elements[0] * other2.elements[1] - other2.elements[0] * other1.elements[1]
        ]);
        // Don't delete the return statement.
        return v3;
    }
    ...
    normalize() {
        ...
        // Don't delete the return statement.
        let scaling_factor = this.magnitude();
        this.elements[0] /= scaling_factor;
        this.elements[1] /= scaling_factor;
        this.elements[2] /= scaling_factor;
